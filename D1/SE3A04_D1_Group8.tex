...
\begin{itemize}
	\item https://play.google.com/store/apps/details?id=ru.egoroffsoft.avtopix&hl=en_CA&pli=1
	\item https://play.google.com/store/apps/details?id=com.mm999.car&hl=en_CA
\end{itemize}
% End SubSection
...
\begin{itemize}
	...
	\item BE2 Authenticate Account
	\item BE3 Upload Input
	\item BE4 Compare Expert Answers
	\item BE5 Present Identification Information
	\item BE6 Add to Car Collection
\end{itemize}
...
\begin{itemize}
	\item VP1 Users
	\item VP2 Marketing (RideRecon)
	\item VP3 Customer Support (RideRecon)
	\item VP4 Identification Accuracy
\end{itemize}
...
\includegraphics[scale=0.1]{images/james_signature.png}& \includegraphics[height=0.6cm]{images/olivia_signature.png} & \includegraphics[height=0.6cm]{images/omar_signature.png} \\ \hline
\end{tabular}
