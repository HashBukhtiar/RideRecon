...
\begin{itemize}
    ...
    \item[3] \url{https://medium.com/design-bootcamp/left-handedness-and-mobile-user-experience-a3728c72f880}
    \item[4] \url{https://venngage.com/blog/color-blind-design/}
\end{itemize}
...
\begin{enumerate}[label={CP-C\arabic*.}]
    \item Determines between wheel on right side vs. wheel on the left side	
\end{enumerate}
% End SubSubSection
