...
\begin{enumerate}[{UH-EOU}1. ]
	\item The application should only require a maximum of two inputs from the user to produce an output.\\
	...
	\item The application should be usable with only one hand.\\
...
\begin{enumerate}[{UH-PI}1. ]
	\item The app should have a variety of language options to choose from.\\
...
\begin{enumerate}[{UH-L}1. ]
	\item The application should require a user to know how to take a picture with their camera.
	\textbf{Rationale:} Camera would be a form of input for the user so familiarity with using it is essential.\\
	\item The application should require a user to know how to use their phone keyboard.\\
	\textbf{Rationale:} Another form of input for the user.
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{UH-A}1. ]
	\item The application should be able to accommodate users with colour blindness.\\
	\textbf{Rationale:} All manners of users will be using this application, including those with colour blindness. Thus, it would be unethical if they were unable to use the app based on our design decisions.
	\item
\end{enumerate}
% End SubSubSection
...
\includegraphics[height=1cm]{hashim_signature.png} & \includegraphics[height=1cm]{JadenSig.jpg} & 
\includegraphics[scale=0.1]{james_signature.png}& \includegraphics[height=0.6cm]{olivia_signature.png} & SIGNATURE \\ \hline
\end{tabular}
