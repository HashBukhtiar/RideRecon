...
\includegraphics[height=1cm]{hashim_signature.png} & \includegraphics[height=1cm]{JadenSig.jpg} & SIGNATURE & \includegraphics[height=0.6cm]{olivia_signature.png} & SIGNATURE \\ \hline
\end{tabular}
